...
public class GuiGenericButton extends AbstractTAEButton<Void> {

	public GuiGenericButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, String info,
			int scale) {
