...
!! Uses data and information from !!
- api.2b2t.dev
- 2b2t.io
...
- Able to create prefixs to player's chat messages to make them stand out
...
#### Packet Cancelling
- Intercept packets leaving or being recieved by your client

#### Packet Tracking
- An easy way to visualize the flow of packets between the server and your client

#### Book and Map Hovering
